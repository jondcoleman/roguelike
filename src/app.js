...
function initHero() {
  return {
    ...
    detail: {
      ...
      hp: 100,
      maxHP: 100,
      weapon: { detail: { name: 'fist', attack: 5 } },
      attack: 5,
      level: 1,
      row: undefined,
      col: undefined
    ...
    checkLevelUp() {
      if (this.detail.xp > (100 * this.detail.level)) {
        this.detail.level++
        this.detail.attack = this.detail.weapon.detail.attack * this.detail.level
      ...
      <div>
        ...
        <div className="hero-detail-container">
            <ul className="list-group">
              ...
              <li className="list-group-item">Weapon: {this.state.hero.detail.weapon.detail.name}</li>
            </ul>
